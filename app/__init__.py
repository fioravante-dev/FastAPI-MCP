...
from app.api.routers import chat_router, status_router,doc_qa_router,employee_management_router
...
app.include_router(employee_management_router.router, prefix="/api/v1", tags=["Employee Management"])
